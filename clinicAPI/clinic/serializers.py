...
from .models import ClinicUser, Clinic, Staff, Message, Appointment, Notification, Expertise, Role
...
class AppointmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Appointment
        fields = ['id', 'appointment_date', 'appointment_status', 'category', 'patient', 'doctor', 'clinic', 'date_created']

class NotificationSerializer(serializers.ModelSerializer):
    class Meta:
        model = Notification
        fields = ['recipient', 'dateReceived', 'content']
